...
------------------------------------------
We include a fix for a bug in the Crypticcoind wallet which could result in Sprout
...
“crypticcoind -rescan”. Sprout address balances shown by the crypticcoind wallet should
then be correct.
...
[Pull request](https://github.com/crypticcoin/crypticcoin/pull/3897)

Miner address selection behaviour fixed
---------------------------------------
Crypticcoin inherited a bug from upstream Bitcoin Core where both the internal miner
...
[Mining Guide](https://crypticcoin.readthedocs.io/en/latest/rtd_pages/crypticcoin_mining_guide.html)
...
[ZIP draft](https://github.com/crypticcoin/zips/pull/210).

The consensus rule will be enforced on mainnet in a future release.

[Pull request](https://github.com/crypticcoin/crypticcoin/pull/3885)
