...
in [ZIP 243](https://github.com/crypticcoin/zips/blob/master/zip-0243.rst) and the
[Sapling spec](https://github.com/crypticcoin/zips/blob/master/protocol/sapling.pdf)
...
`crypticcoin-fetch-params --testnet` (for binary / Debian users).
...
crypticcoin-cli: arguments privacy
----------------------------
...
For example:
    ...
    $ src/crypticcoin-cli -stdin walletpassphrase
    mysecretcode
    120
    ^D (Ctrl-D)
...
Jack Grigg (55):
      Disable building libcrypticcoinconsensus by default
      ...
      [Bitcoin-Tx] Adjust util-test test cases for Crypticcoin
      Handle usage of prevector for CScript in Crypticcoin-specific code
      GetSerializeSize changes in Crypticcoin-specific code
      Remove nType and nVersion from Crypticcoin-specific code
      ...
      Use CBitcoinAddress wrappers in Crypticcoin-specific code
      ...
      Add key_io includes to Crypticcoin-specific code
...
Larry Ruane (1):
      fix qa/crypticcoin/full_test_suite.py pathname
...
Simon Liu (18):
      ...
      Refactoring: libcrypticcoin::Note is now a subclass of libcrypticcoin::BaseNote.
      Refactoring: Rename class libcrypticcoin::Note to libcrypticcoin::SproutNote.
