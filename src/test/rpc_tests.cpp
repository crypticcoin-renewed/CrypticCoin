...
BOOST_AUTO_TEST_CASE(rpc_insightexplorer)
{
    ...
    CheckRPCThrows("getblockdeltas \"a\"",
        ...
        "Run './crypticcoin-cli help getblockdeltas' for instructions on how to enable this feature.");
    CheckRPCThrows("getblockhashes 0 0",
        "Error: getblockhashes is disabled. "
        "Run './crypticcoin-cli help getblockhashes' for instructions on how to enable this feature.");
